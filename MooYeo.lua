...
local Window = Library.CreateLib("YENO_X // Made my Y3PID", "DarkTheme")
...
Section:NewButton("kick myself", "ButtonInfo", function()
    game.Players.LocalPlayer:Kick('Try To Rejoin')
end)
